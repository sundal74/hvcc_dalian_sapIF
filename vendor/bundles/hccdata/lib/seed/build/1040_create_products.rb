puts "Loading [1040_create_products] file..."
...
File.open(File.dirname(__FILE__) + '/PRODUCTS.csv', 'r').each_with_index do |line, index|
  if index == 0
    # 첫 번째 라인은 헤더 정보 
...
puts "Total #{data_count} Products Loaded!"