/**
 * DailyplanVsOutput controller
 */
Ext.define('Hcc.controller.dailyplan_vs_output.DailyplanVsOutput', {
	
	extend: 'Base.abstract.PivotReportController',
	
	requires : ['Hcc.view.dailyplan_vs_output.DailyplanVsOutput'],

	init: function() {
		this.callParent(arguments);
		
		this.control({
			'hcc_dailyplan_vs_output' : {
				paramschange : this.onParamsChange
			},
			'hcc_dailyplan_vs_output_search' : {
