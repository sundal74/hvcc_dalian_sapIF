 ...
 * LineStop Maint
 */
Ext.define('Term.view.lnst.OpLnstP030', {
	
	extend : 'Base.abstract.Popup',
	
	requires : ['Ext.ux.CheckColumn', 'Base.view.common.DatetimeCombo', 'Term.store.HourStore', 'Term.store.MinStore'],

	xtype : 'term_lnst_oplnstp030',
