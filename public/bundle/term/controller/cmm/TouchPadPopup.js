 ...
 */
Ext.define('Term.controller.cmm.TouchPadPopup', {
	
	extend : 'Term.abstract.TerminalController',
	
	views : ['Term.view.cmm.TouchPadPopup'],
	...
	refs: [ 
		{ ref : 'MainView', selector : 'term_touch_pad_popup' },
	],
	
	init : function() {
		this.control({
			'term_touch_pad_popup' : {
