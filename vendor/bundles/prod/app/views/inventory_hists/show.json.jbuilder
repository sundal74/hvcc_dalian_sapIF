json.(@inventory_hist, :id,:domain_id,:inventory_id,:machine_id,:store_id,:product_id,:inv_qty,:qty,:action_code,:lot_type,:lot_id,:from_store_id,:to_store_id,:updated_at)
