Ext.define('Prod.view.workcenter.WorkcenterList', {
	
	extend : 'Base.abstract.entity.ListGrid2View',
	
	xtype : 'prod_workcenter_list',
		
	store : 'Prod.store.Workcenter',
	...
	columns : [
		...
		{ header : T('label.description'), dataIndex : 'description', flex : 1.5 },
		{ 
			xtype : 'codecolumn',
