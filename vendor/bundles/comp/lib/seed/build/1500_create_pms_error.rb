puts "Loading [1500_create_pms_error] file..."
...
File.open(File.dirname(__FILE__) + '/PMS_ERROR.csv', 'r').each_with_index do |line, index|
  if index == 0
    # 첫 번째 라인은 헤더 정보 
    ...
    PmsError.create!(data)
    data_count += 1
  end
end

puts "Total #{data_count} Pms Error Loaded!"