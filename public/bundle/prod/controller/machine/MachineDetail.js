/**
 * MachineDetail controller
 */
Ext.define('Prod.controller.machine.MachineDetail', {
	...
	requires : [ 
		'Prod.model.Machine', 
		'Prod.store.Machine', 
		'Prod.view.machine.MachineDetail'
	],
	...
	views : ['Prod.view.machine.MachineDetail'],
	
	refs: [ { ref : 'MachineDetail', selector : 'prod_machine_detail' } ],
	...
	afterFormSaved : function(form, newRecord) {
		...
		HF.show('Prod.view.machine.Machine', {}, {});
	},
